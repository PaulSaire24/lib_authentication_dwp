...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("PDWYR008IMPL-0.1.0-SNAPSHOT");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("0.1.0-SNAPSHOT"));
		return mockBundle;
	}
